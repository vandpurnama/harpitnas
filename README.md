...
- Karena menggunakan ocr ada kemungkinan bahwa akan ada tanggal atau kata yang masih kurang atau tidak akurat harap validasi kembali sebelum digunakan untuk production 
